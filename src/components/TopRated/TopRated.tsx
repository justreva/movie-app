...
const TopRated = ({ movie }: topRatedProps) => {
  ...
  return (
    <div
      ...
      className=" w-[650px] border relative border-border hover:border-secondary duration-150 rounded-lg overflow-hidden cursor-pointer shadow-lg"
    >
      <div className="">
        <img
