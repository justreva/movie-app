...
import { fetchTrendingMovies, fetchTrendingSeries } from "../../api/tmdb";
...
const Home = () => {
  ...
  const trendingSerialsQuery = useQuery(
    ["trendingSerials", serialTimeWindow],
  ...
  const trendingSerials = trendingSerialsQuery.data?.data.results || [];
